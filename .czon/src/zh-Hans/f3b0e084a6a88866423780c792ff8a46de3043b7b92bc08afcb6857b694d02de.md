---
"title": "Zola博客实时编辑与后端方案设计任务清单"
"summary": "本文档是一份关于Zola博客集成WYSIWYG
  Markdown实时编辑器和Supabase/GitHub后端方案的设计任务清单。文档分为四个主要阶段：现状审计与约束、编辑器选型调研、后端与数据模型设计\
  、整合方案详细设计与落地计划，每个阶段包含具体任务和验收标准。当前所有设计任务已完成，进入review阶段。文档还列出了MVP（最小可用产品）建议范围，包\
  括/admin页面、Supabase表结构、编辑器集成、发布流程等核心功能，以及v2增强项如图片上传、版本历史和多文档管理。最后更新时间为2026年01月\
  06日。"
"tags":
  - "Zola"
  - "Markdown"
