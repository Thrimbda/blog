---
"title": "初探并发"
"summary": "本文作者通过一个小作业接触到并发编程，使用Python的queue、signal和time模块创建了一个简单的demo，演示了如何通过\
  消息队列实现线程间通信。文章解释了queue作为消息队列、signal用于捕捉KeyboardInterrupt、time用于主线程响应的作用，并探讨了多\
  线程环境下使用消息队列降低系统耦合的设计思想，强调“为变化而设计”的重要性。"
"tags":
  - "python"
  - "并发"
  - "多线程"
