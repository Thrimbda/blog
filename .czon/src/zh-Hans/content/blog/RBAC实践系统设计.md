---
"title": "RBAC概念与系统设计"
"summary": "本文详细阐述了基于角色的访问控制（RBAC）模型，包括其核心概念如主体、角色、权限、会话等对象及其多对多关系。文章解释了RBAC作为一\
  种强制访问控制（MAC）模型，由系统管理员统一管理用户角色，并强调了在会话期间主体只能行使一个角色的权限。作者进一步探讨了RBAC的应用场景，指出它适用于\
  资源由系统共有且具有分层角色的系统，如商业公司和遵循最小权限原则的操作系统。同时，文章对比了自由选定访问控制（DAC）模型，指出在资源由个人拥有的系统（如\
  社交网络）中DAC更合适，并提到实际应用中常混合使用两种模型。"
"tags":
  - "系统设计与分析"
  - "RBAC"
  - "访问控制"
