---
"title": "RBAC概念与系统设计"
"summary": "本文详细阐述了RBAC（基于角色的访问控制）模型的核心概念，包括主体、角色、权限、会话等对象及其多对多关系。文章解释了RBAC作为一种\
  强制访问控制模型，由系统管理员统一管理用户角色，并强调了在会话期间主体只能行使一个角色的权限。作者进一步探讨了RBAC的应用场景，即资源由系统共有且具有多\
  种分层角色的系统，如商业公司和遵循最小权限原则的操作系统。同时，文章对比了DAC（自主访问控制）模型，指出在资源由个人拥有的系统中DAC更为合适，并建议在\
  实际场景中混合使用两种模型。最后，以微信为例说明了混合模型的实际应用。"
"tags":
  - "RBAC"
  - "系统设计"
  - "访问控制"
