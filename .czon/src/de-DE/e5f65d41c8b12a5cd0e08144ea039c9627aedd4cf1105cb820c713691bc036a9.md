...
- MapReduce
- Ähnlich zu DryadLINQ (im Kontext von Scala)
...
- Weder Hadoop noch Spark zu dieser Zeit konnten MapReduce (in seiner ursprünglichen, etablierten Form/Verbreitung?) übertreffen. (Anmerkung: Der letzte Satz scheint einen Vergleich oder eine Einschränkung auszudrücken, die im Kontext der damaligen Zeit zu verstehen ist. Die Übersetzung versucht, den Sinn zu erfassen.)