---
"title": "2020年5月工作日志"
"summary": "本文是2020年5月的工作日志，详细记录了在技术开发、问题解决和项目规划方面的日常工作。主要内容包括：修复内存泄漏问题，根本原因在于野\
  指针未删除，通过重构NaviEventProvider解决；处理PolyLine重复点导致的几何计算异常；修复多个HDMAPMDK相关的bug，如产线切分\
  不合理导致的错误；进行OSM Assembler重构；规划CI
  Pipeline的现状和需求；以及处理突发任务如停车位绑定错误等。日志还反映了对时间估计、问题解决模式（短期与长期方案）的思考，以及面试和团队协作的经历。"
"tags":
  - "工作日志"
  - "技术"
  - "bug修复"
