...
"summary": "本文详细介绍了作者如何将机核（Gcores）上的机组内容迁移到个人博客的技术过程。文章从旧博客因依赖过时失效开始，讲述了选择Zola作\
  为新博客生成器的原因，并重点描述了通过API抓取机组数据、处理成Markdown格式，以及使用HTML、CSS和JavaScript实现滑动图片组的前端交\
  互。作者强调了前端开发中快速反馈循环带来的快乐，并分享了触控交互的RxJS实现。最后，文章总结了对博客完全掌控的满足感和编码的纯粹乐趣，尽管内容相对浅薄，\
  但过程充满成就感。"
"tags":
  - "博客"
  - "技术"
...
搭个人博客的风潮是在大三那年我们系流行来的。7 年前[这篇](czon://5221db5c2766ca0baade64eb4959a1c4fb1596bf1294c20de8af0c1448781374)令我脚趾抓地的文章介绍了最初我搭建这个博客的心路历程。
