...
- [x] 收口正文无序列表与有序列表的缩进节奏差异，避免读者感知到两套不同的缩进列 | 来源: 用户反馈：感觉无序列表和有序列表的缩进不一样
- [x] 为 `content/blog/markdown-render-showcase.md` 补齐 1-6 级标题样本，并验证生成页标题层级完整 | 来源: 用户追加要求：把 123456 级标题都在 markdown showcase 文章里搞了
