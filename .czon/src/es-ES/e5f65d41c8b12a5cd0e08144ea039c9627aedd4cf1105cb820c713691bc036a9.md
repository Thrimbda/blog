...
-   Supera ampliamente a Hadoop, hasta 10 veces más rápido.
...
-   Tanto Hadoop como Spark en ese momento no podían superar a MapReduce (en términos de adopción/dominio del mercado).