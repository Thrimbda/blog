---
"title": "2020 工作日志"
"summary": "本文档是作者2020年上半年的工作日志，详细记录了从4月到7月期间的工作内容，主要包括地图数据编译系统的开发、bug修复、技术重构（如\
  TLM重构）、团队协作（如与同事讨论接口和方案）、面试以及个人职业发展的思考。文档不仅涉及具体的技术任务（如自定义限速、车道线绑定、内存泄漏修复），还包含\
  了作者对工作效率、代码质量、项目管理（如CI/CD管道）和职业规划的反思。作者在日志中多次表达了对工作意义的探寻、对技术决策的批判性思考，以及在高压交付环\
  境下的心态变化。"
"tags":
  - "工作日志"
  - "软件开发"
